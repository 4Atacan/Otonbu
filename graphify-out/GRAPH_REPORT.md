...
## Corpus Check
- 38 files · ~33,103 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 236 nodes · 306 edges · 16 communities (15 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3811df9c`
...
2. `expo` - 12 edges
3. `supabase` - 11 edges
4. `OTONBU GARAGE — Proje Talimatları` - 9 edges
5. `OTONBU GARAGE — Uygulama Planı` - 9 edges
6. `Faz 2 — Randevu akışı (yayınlanabilir MVP)` - 9 edges
7. `Faz 3 — Abonelik + ödeme` - 9 edges
8. `scripts` - 8 edges
9. `Faz 1 — Temel iskelet` - 8 edges
10. `Faz 4 — Zenginleştirme + KVKK tamamlama` - 8 edges
...
Cohesion: 0.08
Nodes (25): Abonelik mantığı (Edge Functions), Faz 0 — Proje kurulumu, Faz 3 — Abonelik + ödeme, Faz 4 — Zenginleştirme + KVKK tamamlama, Görevler, iyzico ödeme akışı (Edge Functions), Kabul kriteri, Kabul kriteri (+17 more)
...
Cohesion: 0.10
Nodes (27): RootLayout(), useSession(), initSentry(), supabase, AraclarScreen(), AnaSayfa(), s, KampanyalarScreen() (+19 more)
...
## Knowledge Gaps
- **143 isolated node(s):** `PreToolUse`, `name`, `slug`, `version`, `orientation` (+138 more)
